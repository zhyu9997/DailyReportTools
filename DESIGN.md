...
Tests/DailyReportTests/             # Swift Testing 套件，190 tests / 13 suites（详见 14.测试）
```
...
`Tests/DailyReportTests/` 下用 Swift Testing 框架，190 tests / 13 suites 全绿。运行需 Xcode 工具链（纯 CLT 不带 Testing 模块）：
